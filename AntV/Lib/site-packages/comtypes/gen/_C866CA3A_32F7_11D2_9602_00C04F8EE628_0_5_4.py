...
__all__ = [
    'SPPS_NotOverriden', 'SDTPronunciation', 'DISPID_SGRsCommit',
    'ISpRecognizer3', 'SPCT_SLEEP', 'DISPID_SAEventHandle',
    'DISPID_SVSVisemeId', 'ISpeechPhraseReplacement',
    'SVSFPurgeBeforeSpeak', 'SP_VISEME_9',
    'DISPID_SASFreeBufferSpace', 'SPEVENTSOURCEINFO',
    'DISPID_SVEStreamEnd', 'DISPID_SVESentenceBoundary',
    'DISPID_SRGetPropertyString', 'SVP_2', 'ISpeechPhraseInfoBuilder',
    'SP_VISEME_4', 'SPDKL_CurrentConfig', 'SRAONone',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechLexiconType',
    'DISPID_SRCResume', 'SBONone', 'Speech_Max_Pron_Length',
    'SpeechPropertyNormalConfidenceThreshold', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_PRIVATE10', 'ISpeechPhraseProperties',
    'DISPID_SRGRules', 'DISPID_SRRSetTextFeedback',
    'DISPID_SMSAMMHandle', 'ISpPhoneticAlphabetConverter',
    'SPWORDTYPE', 'SPEI_RECO_STATE_CHANGE', 'SSFMOpenForRead',
    'DISPID_SRGetRecognizers', 'SpeechCategoryRecognizers',
    'ISpeechFileStream', 'SVSFIsNotXML', 'SLOStatic',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SPIElements',
    'SVEPrivate', 'DISPID_SPRuleName', 'SAFT24kHz16BitStereo',
    'SPEI_PHRASE_START', 'DISPID_SRRTimes',
    'DISPID_SWFEBitsPerSample', 'DISPID_SpeechAudioStatus',
    'eWORDTYPE_DELETED', 'DISPID_SOTSetId',
    'SWPUnknownWordUnpronounceable', 'DISPID_SOTIsUISupported',
    'DISPID_SGRId', 'SPEI_RESERVED3', 'SAFT8kHz16BitMono',
    'DISPID_SWFEChannels', 'DISPID_SpeechPhraseElements',
    'eLEXTYPE_PRIVATE11', 'SAFT24kHz8BitStereo',
    'SpeechAudioFormatGUIDText', 'ISpVoice', 'SPPHRASEELEMENT',
    'SDA_One_Trailing_Space', 'DISPID_SADefaultFormat',
    'ISpeechRecoGrammar', 'DISPID_SPRuleId', 'SPEI_MIN_TTS',
    'DISPID_SPRuleConfidence', 'SP_VISEME_0', 'SAFTDefault',
    'ISpPhoneticAlphabetSelection', 'DISPID_SpeechRecoResult',
    'SREPhraseStart', 'SAFTCCITT_uLaw_8kHzStereo', 'SSFMCreate',
    'tagSPPROPERTYINFO', 'DISPID_SRCEFalseRecognition',
    'DISPID_SpeechPhraseElement', 'SDA_Two_Trailing_Spaces',
    'IStream', 'SP_VISEME_11', 'IEnumSpObjectTokens', 'DISPID_SOTCId',
    'SAFTGSM610_44kHzMono', 'SAFTExtendedAudioFormat', 'ISpShortcut',
    'DISPID_SRRTStreamTime', 'DISPID_SPEsItem', 'DISPIDSPTSI',
    'SPEI_VOICE_CHANGE', 'SRSActive', 'SpNullPhoneConverter',
    'ISpeechPhraseRule', 'DISPID_SVPause', 'DISPID_SVIsUISupported',
    'DISPID_SPIGrammarId', 'SPAS_STOP', 'STSF_FlagCreate',
    'DISPID_SVResume', 'DISPIDSPTSI_ActiveOffset', 'SRCS_Disabled',
    'DISPID_SOTsItem', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTADPCM_22kHzStereo', 'SP_VISEME_10', 'SpInProcRecoContext',
    'eLEXTYPE_PRIVATE13', 'SpeechGrammarRuleStateTransitionType',
    'SLTApp', 'DISPID_SVSInputSentenceLength', 'SAFTNoAssignedFormat',
    'SPSHT_NotOverriden', 'STSF_AppData', 'DISPID_SGRSTPropertyId',
    'SAFT32kHz8BitStereo', 'DISPID_SRGCmdSetRuleState',
    'SpeechVoiceCategoryTTSRate', 'SAFT48kHz8BitStereo',
    'SPPS_RESERVED2', 'SpeechCategoryAudioIn',
    'SPINTERFERENCE_TOOQUIET', 'SpeechRecognitionType', 'ISpLexicon',
    'ISpeechVoice', 'ISpeechGrammarRuleStateTransitions',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPRules_NewEnum',
    'SECFIgnoreKanaType', 'DISPID_SpeechCustomStream',
    'SAFTADPCM_44kHzMono', 'SPEI_MIN_SR', 'SSSPTRelativeToStart',
    'SVP_1', 'eLEXTYPE_PRIVATE17',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRGRecoContext',
    'DISPID_SASetState', 'SPINTERFERENCE',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SOTGetDescription', 'SDA_No_Trailing_Space',
    'DISPID_SPPParent', 'SVF_Stressed', 'ISpStream',
    'SpeechDictationTopicSpelling', 'SRCS_Enabled', 'ISpRecoCategory',
    'SPFM_CREATE', 'DISPID_SRGCmdLoadFromObject',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpAudio', 'SPPS_RESERVED4',
    'SRTExtendableParse', 'SpeechEngineProperties',
    'SPEI_TTS_PRIVATE', 'SpeechTokenKeyFiles', 'ISpObjectToken',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SBSRead', 'ISpeechDataKey',
    'DISPID_SRRPhraseInfo', 'SPSHT_EMAIL', 'Speech_Default_Weight',
    'DISPID_SRRTTickCount', 'DISPID_SRCCreateGrammar',
    'SpCompressedLexicon', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SPAsCount',
    'DISPID_SRRTLength', 'SPWF_INPUT', 'DISPID_SpeechMMSysAudio',
    'SVP_17', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPCIdToPhone', 'SPSTREAMFORMATTYPE', 'SVP_21',
    'SAFT8kHz16BitStereo', 'SAFT44kHz16BitStereo',
    'DISPID_SVEBookmark', 'SGRSTTRule', 'SPGS_EXCLUSIVE',
    'ISpeechCustomStream', 'ISpXMLRecoResult', 'SPAUDIOSTATE',
    'SP_VISEME_12', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechPhraseRules', 'SpSharedRecognizer',
    'DISPID_SPIAudioSizeTime', 'SPSHT_OTHER', 'ISpGrammarBuilder',
    'ISpeechRecoResult', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SRProfile', 'ISpeechRecoResultDispatch',
    'DISPID_SpeechFileStream', 'DISPID_SRCEPhraseStart',
    'DISPID_SPAsItem', 'DISPID_SFSOpen', 'DISPID_SLPPartOfSpeech',
    'SPEI_RESERVED6', 'DISPID_SLRemovePronunciation',
    'SPEI_RESERVED2', 'SPXRO_Alternates_SML', 'DISPID_SPRsItem',
    'SVPNormal', 'DISPID_SRGCmdSetRuleIdState', 'STCAll',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPPsCount',
    'SPFM_OPEN_READONLY', 'DISPID_SPRuleEngineConfidence',
    'SPPS_RESERVED1', 'SDKLLocalMachine', 'SECLowConfidence',
    'ISpRecoGrammar2', 'ISpeechWaveFormatEx',
    'DISPID_SRRSaveToMemory', 'ISpRecoGrammar', 'SVEViseme',
    'SLTUser', 'SPSHORTCUTPAIR', 'SGRSTTTextBuffer',
    'DISPID_SOTCategory', 'SPPHRASEPROPERTY', 'SP_VISEME_15',
    'DISPID_SRSNumberOfActiveRules',
    'SpeechPropertyComplexResponseSpeed', 'SpeechPartOfSpeech',
    'SpeechWordType', 'DISPID_SpeechXMLRecoResult',
    'SWPUnknownWordPronounceable', 'SP_VISEME_5',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SDKCreateKey',
    'DISPID_SLWsCount', 'SGDSInactive', 'SPCT_SUB_COMMAND',
    'SPCONTEXTSTATE', 'DISPID_SVStatus', 'SPXRO_SML',
    'SPTEXTSELECTIONINFO', '_ISpeechVoiceEvents',
    'DISPID_SpeechPhraseAlternate', 'SDKLCurrentUser',
    'DISPID_SRCEventInterests', 'SVEAllEvents', 'DISPID_SMSALineId',
    'SRTStandard', 'DISPID_SLWsItem', 'SECFNoSpecialChars', 'SVP_13',
    'DISPID_SLGetPronunciations', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRRSpeakAudio', 'DISPID_SpeechRecoResultTimes',
    'SGSDisabled', '_RemotableHandle', 'SAFT11kHz16BitMono',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SVEEnginePrivate',
    'SBOPause', 'SSFMOpenReadWrite', 'SPEI_MAX_SR',
    'SAFT48kHz16BitStereo', 'DISPID_SGRsFindRule',
    'DISPID_SVEVoiceChange', 'DISPID_SABIEventBias', 'SPGS_DISABLED',
    'SVF_Emphasis', 'SPDATAKEYLOCATION',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SGRName', 'SWTDeleted',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRRRecoContext', 'IInternetSecurityMgrSite',
    'eLEXTYPE_RESERVED7', 'DISPIDSPTSI_SelectionOffset',
    'SECHighConfidence', 'SVPAlert', 'DISPID_SRGCommit',
    'SPRECORESULTTIMES', 'eLEXTYPE_PRIVATE5', 'DISPID_SPRs_NewEnum',
    'SpeechSpecialTransitionType', 'ISpMMSysAudio', 'ISpEventSink',
    'SPGS_ENABLED', 'SECFDefault', 'SPRULE', 'SVSFDefault',
    'Speech_StreamPos_RealTime', 'DISPID_SPEsCount',
    'DISPID_SLGenerationId', 'eLEXTYPE_PRIVATE6',
    'DISPID_SGRAddResource', 'SpObjectToken', 'SVP_15',
    'SECFEmulateResult', 'DISPID_SMSGetData', 'DISPID_SVDisplayUI',
    'ISpeechResourceLoader', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SAVolume', 'DISPID_SRGSetTextSelection',
    'ISpeechLexiconPronunciations', 'DISPID_SDKSetStringValue',
    'DISPID_SAStatus', 'DISPID_SPERequiredConfidence', 'SFTInput',
    'DISPID_SOTsCount', 'DISPID_SRCVoicePurgeEvent',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPSEMANTICERRORINFO', 'SPBO_NONE', 'SRAImport',
    'DISPID_SOTCGetDataKey', 'SPEI_SR_AUDIO_LEVEL', 'SPRST_INACTIVE',
    'DISPID_SGRSTsCount', 'SpeechGrammarWordType',
    'DISPID_SRGetPropertyNumber', 'SPWT_LEXICAL',
    'DISPID_SLAddPronunciation', 'ISpeechAudioBufferInfo',
    'DISPID_SDKSetLongValue', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPRDisplayAttributes', 'DISPID_SWFEAvgBytesPerSec',
    'SAFT16kHz16BitStereo', 'DISPID_SLPs_NewEnum',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_MORPHOLOGY', 'DISPID_SGRClear',
    'DISPID_SpeechPhraseRule', 'SpeechPropertyAdaptationOn',
    'DISPID_SRCRetainedAudioFormat', 'SITooSlow', 'SRTReSent',
    'SPLO_STATIC', 'SpeechLoadOption', 'SPAR_Low',
    'DISPID_SPAPhraseInfo', 'SPVOICESTATUS', 'ISpRecoContext',
    'SpeechCategoryAppLexicons', 'DISPID_SOTMatchesAttributes',
    'Speech_StreamPos_Asap', 'DISPID_SMSSetData', 'SREStreamEnd',
    'DISPID_SVEAudioLevel', 'DISPID_SRCERequestUI',
    'DISPID_SVGetProfiles', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechRecoResult2', 'SPEVENT', 'DISPID_SVEPhoneme',
    'SAFT12kHz16BitStereo', 'SPAUDIOSTATUS',
    'SGLexicalNoSpecialChars', 'SPSSuppressWord',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SOTGetAttribute',
    'SpeechVoiceEvents', 'DISPID_SGRsCommitAndSave', 'SREStateChange',
    'DISPID_SRAudioInput', 'SSTTTextBuffer',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SpeechLexiconWords',
    'ISpeechRecognizer', 'SPWF_SRENGINE', 'DISPID_SPIRule',
    'ISpStreamFormat', 'SpVoice', 'SPEI_WORD_BOUNDARY',
    'DISPID_SAFGuid', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SWFEFormatTag', 'SPSERIALIZEDPHRASE',
    'DISPID_SDKGetStringValue', 'DISPID_SRCEInterference',
    'DISPID_SRGReset', 'DISPID_SASCurrentSeekPosition',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_SR_PRIVATE',
    'DISPID_SRGDictationUnload', 'ISpDataKey',
    'DISPID_SpeechRecoContextEvents', 'SpeechGrammarTagDictation',
    'SpeechCategoryPhoneConverters', 'SVP_4', 'ISpeechLexiconWord',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPIDSPTSI_ActiveLength',
    'STSF_LocalAppData', 'SAFTADPCM_8kHzMono', 'SAFT22kHz8BitStereo',
    'DISPID_SPILanguageId', 'DISPID_SOTGetStorageFileName',
    'SGLexical', 'SpeechVoiceSpeakFlags', 'SAFT12kHz8BitStereo',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVSLastBookmarkId', 'SPVPRI_ALERT',
    'SpMMAudioOut', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SVSyncronousSpeakTimeout', 'SPEI_VISEME',
    'SPADAPTATIONRELEVANCE', 'SVSFParseMask', 'SPEI_SOUND_START',
    'SLODynamic', 'SSTTWildcard', 'SpLexicon', 'eLEXTYPE_PRIVATE7',
    'DISPIDSPRG', 'eLEXTYPE_PRIVATE9', 'SpeechAudioFormatType',
    'SPLEXICONTYPE', 'SPBINARYGRAMMAR', 'SPPS_RESERVED3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', '_SPAUDIOSTATE',
    'DISPID_SRState', 'SPEI_SOUND_END', 'DISPID_SVSPhonemeId',
    'SRTSMLTimeout', 'SPEI_END_SR_STREAM', 'SPPROPERTYINFO',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKEnumKeys',
    'DISPID_SRGCmdLoadFromMemory', 'SRESoundStart',
    'DISPID_SLPPhoneIds', 'SPSEMANTICFORMAT', 'SGRSTTWord',
    'ISpeechRecoContext', 'SpTextSelectionInformation',
    'SVEAudioLevel', 'DISPID_SPCLangId', 'DISPID_SRCEEndStream',
    'SpWaveFormatEx', 'DISPID_SGRSTRule',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechObjectToken',
    'DISPID_SPEAudioStreamOffset', 'SpeechFormatType',
    'DISPID_SGRsCount', 'DISPID_SPRNumberOfElements',
    'SVSFIsFilename', 'SAFT48kHz16BitMono', 'SRSEIsSpeaking',
    'DISPID_SPIGetText', 'DISPID_SPRFirstElement',
    'DISPID_SVSInputWordPosition', 'SPPS_Function', 'SpStream',
    'DISPID_SLPsCount', 'SPSERIALIZEDRESULT', 'SPAS_CLOSED',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SGDSActiveWithAutoPause',
    'DISPID_SDKDeleteKey', 'DISPID_SpeechObjectTokenCategory',
    'SpResourceManager', 'SP_VISEME_17', 'SpeechAudioFormatGUIDWave',
    'SPRST_NUM_STATES', 'IInternetSecurityManager', 'SPSLMA',
    'DISPID_SWFESamplesPerSec', 'SP_VISEME_21', 'eLEXTYPE_PRIVATE4',
    'SDTProperty', 'SPAS_RUN', 'DISPID_SPPs_NewEnum',
    'ISpeechPhraseElements', 'SpeechCategoryAudioOut',
    'ISpeechPhraseProperty', 'SPPS_Verb', 'SRADefaultToActive',
    'WAVEFORMATEX', 'SDTRule', 'SAFT16kHz16BitMono',
    'DISPID_SpeechLexicon', 'STCInprocServer', 'SpAudioFormat',
    'SSTTDictation', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SVEWordBoundary', 'SpMMAudioEnum', 'SPWT_PRONUNCIATION',
    'SP_VISEME_19', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechMemoryStream',
    'eLEXTYPE_PRIVATE1', 'SPRECOGNIZERSTATUS', 'SVSFNLPMask',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechVoiceStatus',
    'SPSHORTCUTTYPE', 'SpeechMicTraining', 'ISequentialStream',
    'SDTReplacement', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRSTs_NewEnum', 'SRSActiveAlways',
    'ISpeechRecognizerStatus', 'DISPID_SRRDiscardResultInfo',
    'SPCT_COMMAND', 'DISPID_SVSpeakStream',
    'DISPID_SpeechAudioBufferInfo', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVAudioOutput', 'SVEVoiceChange', 'SpShortcut',
    'SpeechDiscardType', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPDKL_DefaultLocation', 'SASClosed',
    'SPPHRASE', 'SpeechRetainedAudioOptions', 'SPEI_RECOGNITION',
    'SDTAlternates', 'eLEXTYPE_USER', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SDKOpenKey', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_PHONEME',
    'SSFMCreateForWrite', 'SPFM_CREATE_ALWAYS', 'LONG_PTR',
    'SpInprocRecognizer', 'SPLO_DYNAMIC', 'SpeechEngineConfidence',
    'SP_VISEME_1', 'SAFT44kHz8BitStereo', 'SREPrivate',
    'STCLocalServer', 'SPSMF_UPS', 'DISPID_SGRSTPropertyName',
    'SASStop', 'SAFTNonStandardFormat', 'SPCT_DICTATION', 'SPWORD',
    'SPAR_High', 'ISpeechVoiceStatus',
    'SSSPTRelativeToCurrentPosition', 'DISPIDSPTSI_SelectionLength',
    'SpMemoryStream', 'SpeechVisemeType', 'SPSInterjection', 'SVP_0',
    'SRATopLevel', 'STSF_CommonAppData', 'ISpPhoneConverter',
    'DISPID_SGRSTPropertyValue', 'ISpProperties', 'SREStreamStart',
    'DISPID_SPRText', 'SPEI_END_INPUT_STREAM', 'DISPID_SDKEnumValues',
    'SVP_14', 'DISPID_SOTCreateInstance', 'SPEI_MAX_TTS',
    'SPWORDPRONOUNCEABLE', 'DISPID_SRCRequestedUIType',
    'DISPID_SRGDictationLoad', 'SpeechCategoryVoices',
    'DISPID_SVSInputWordLength', 'SAFT24kHz8BitMono',
    'SpeechTokenKeyAttributes', 'SAFT11kHz8BitStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SABufferNotifySize',
    'DISPID_SRStatus', 'SpeechRecoEvents', 'SVEBookmark',
    'DISPID_SGRsItem', 'SpObjectTokenCategory',
    'SpeechCategoryRecoProfiles', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRCESoundEnd', 'SVP_11', 'DISPID_SOTs_NewEnum',
    'SpeechPropertyResourceUsage', 'SGDSActiveUserDelimited',
    'DISPID_SpeechPhraseProperties', '_ISpeechRecoContextEvents',
    'DISPID_SGRSTransitions', 'DISPID_SPACommit',
    'SPINTERFERENCE_TOOFAST', 'SREFalseRecognition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechLexiconWord', 'DISPID_SLGetWords', 'ISpNotifySink',
    'SPWT_DISPLAY', 'SRERecognition', 'DISPID_SOTRemove',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVGetAudioOutputs',
    'SGDSActive', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPEAudioTimeOffset', 'SPINTERFERENCE_TOOLOUD', 'SDTAudio',
    'SGSExclusive', 'ISpeechGrammarRuleState', 'ISpeechAudio',
    'SPINTERFERENCE_NONE', 'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE3',
    'SAFT44kHz8BitMono', 'ISpeechXMLRecoResult',
    'DISPID_SRCEAdaptation', 'DISPID_SRCEBookmark',
    'DISPID_SpeechGrammarRules', 'ISpeechPhraseReplacements',
    'DISPID_SRRecognizer', 'SPEI_RESERVED5', 'SVF_None',
    'eLEXTYPE_RESERVED8', 'DISPID_SRCERecognizerStateChange',
    'SAFT12kHz8BitMono', 'SPVPRI_NORMAL', 'DISPID_SPPsItem',
    'DISPID_SPIStartTime', 'SpUnCompressedLexicon',
    'SpeechAudioProperties', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPIAudioStreamPosition', 'SRERequestUI',
    'DISPID_SpeechAudio', 'DISPID_SPRsCount',
    'SREPropertyStringChange', 'SPAR_Unknown', 'DISPID_SLPLangId',
    'SP_VISEME_20', 'SPVISEMES', 'DISPID_SpeechRecoContext',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPPHRASERULE',
    'SVSFParseSsml', 'DISPID_SPPEngineConfidence', 'SpeechTokenKeyUI',
    'DISPID_SpeechPhoneConverter', 'SAFTADPCM_11kHzStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SGRAttributes', 'ISpRecoContext2', 'DISPID_SASState',
    'SGSEnabled', 'ISpObjectTokenCategory',
    'DISPID_SLGetGenerationChange', 'ISpeechPhraseRules',
    'SPPHRASEREPLACEMENT', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SGRSTsItem', 'SPFILEMODE', 'DISPID_SPPConfidence',
    'DISPID_SGRSTType', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechVoice', 'eLEXTYPE_RESERVED4', 'SpMMAudioIn',
    'SPPS_SuppressWord', 'DISPID_SPRuleNumberOfElements',
    'SPRECOCONTEXTSTATUS', 'SpNotifyTranslator', 'UINT_PTR', 'SVP_9',
    'DISPID_SPARecoResult', 'SFTSREngine', 'SPFM_OPEN_READWRITE',
    'SGRSTTWildcard', 'SREBookmark', 'ISpSerializeState',
    'SPDKL_CurrentUser', 'SPGRAMMARSTATE', 'SPFM_NUM_MODES',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGDictationSetState',
    'SPEI_INTERFERENCE', 'SPCS_ENABLED', 'SpeechWordPronounceable',
    'SDTLexicalForm', 'DISPID_SpeechPhraseInfo',
    'SPWORDPRONUNCIATION', 'eLEXTYPE_PRIVATE14', 'SpeechInterference',
    'ISpeechAudioStatus', 'DISPID_SVSLastBookmark',
    'DISPID_SGRAddState', 'SPEI_FALSE_RECOGNITION',
    'SpeechBookmarkOptions', 'DISPID_SRCEEnginePrivate',
    'SPSNotOverriden', 'IEnumString', 'SpeechRuleAttributes',
    'SAFTGSM610_8kHzMono', 'SRSInactive', 'SpeechTokenShellFolder',
    'DISPID_SPEPronunciation', 'SPPS_Interjection',
    'eLEXTYPE_PRIVATE16', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SpeechUserTraining', 'SPPS_LMA', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRGId', 'DISPID_SRCEAudioLevel', 'SPSFunction',
    'DISPID_SOTCSetId', 'SPVPRI_OVER', 'SAFT24kHz16BitMono',
    'SWTAdded', 'ISpeechTextSelectionInformation',
    'DISPID_SABIMinNotification', 'SREAudioLevel',
    'SVSFParseAutodetect', 'SpeechRegistryUserRoot',
    'DISPID_SMSADeviceId', 'DISPID_SPRuleParent', 'SpeechAllElements',
    'DISPID_SGRInitialState', 'ISpeechPhraseInfo',
    'SAFT44kHz16BitMono', 'SRERecoOtherContext', 'SPCATEGORYTYPE',
    'SVP_6', 'DISPID_SPEs_NewEnum', 'DISPID_SpeechObjectToken',
    'SRARoot', 'ISpeechMMSysAudio', 'SAFT48kHz8BitMono',
    'SVSFNLPSpeakPunc', 'SDKLCurrentConfig', 'DISPID_SOTCDefault',
    'SAFTADPCM_22kHzMono', 'SpeechRecognizerState', 'SVSFPersistXML',
    'SECFIgnoreWidth', 'SP_VISEME_8', 'DISPID_SPIEnginePrivateData',
    'SITooQuiet', 'ISpeechPhraseElement', 'DISPID_SGRSTNextState',
    'DISPID_SRRAlternates', 'SVSFlagsAsync',
    'DISPID_SRSetPropertyNumber', 'SAFT11kHz16BitStereo',
    'SGPronounciation', 'ISpPhraseAlt', 'SPRST_ACTIVE',
    'SPAUDIOBUFFERINFO', 'SpeechRunState', 'DISPID_SVVolume',
    'DISPID_SVGetVoices', 'SVP_20', 'DISPID_SPIEngineId',
    'eWORDTYPE_ADDED', 'SPSHT_Unknown', 'SVP_8', 'DISPID_SRGState',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPIReplacements', 'SpSharedRecoContext',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRIsUISupported',
    'DISPID_SOTDataKey', 'SPLOADOPTIONS', 'Speech_Max_Word_Length',
    'SpeechStreamFileMode', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRSSupportedLanguages',
    'SASPause', 'SWPKnownWordPronounceable', 'SDTDisplayText',
    'DISPID_SVEventInterests', 'SRSInactiveWithPurge', 'tagSTATSTG',
    'DISPID_SLPSymbolic', 'SRESoundEnd', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSpeak', 'SpeechGrammarTagWildcard',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVVoice', 'SP_VISEME_18',
    'SREAdaptation', 'SP_VISEME_13', 'SpCustomStream',
    'SPEI_SENTENCE_BOUNDARY', 'SVSFIsXML',
    'DISPID_SRCreateRecoContext', 'SAFT8kHz8BitStereo',
    'SAFT16kHz8BitMono', 'SAFT32kHz16BitMono', 'SPPS_Noncontent',
    'SPPARTOFSPEECH', 'SRAORetainAudio', 'SPSModifier',
    'SAFT12kHz16BitMono', 'eLEXTYPE_APP',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SWFEExtraData',
    'SpeechPropertyResponseSpeed', 'DISPID_SRCEHypothesis',
    'DISPID_SPRulesItem', 'SGRSTTEpsilon',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE8',
    'SP_VISEME_3', 'DISPID_SpeechGrammarRuleStateTransition',
    'SRAExport', 'DISPID_SLWWord', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPEDisplayText', 'SPEI_SR_BOOKMARK',
    'DISPID_SPEDisplayAttributes', 'SpeechTokenValueCLSID',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPSVerb', 'DISPID_SRCBookmark',
    'SVP_3', 'SVP_16', 'ISpStreamFormatConverter', 'SPRS_ACTIVE',
    'SpFileStream', 'SP_VISEME_6', 'SVP_5', 'SPWORDLIST', 'SVP_19',
    'SPRST_ACTIVE_ALWAYS', 'SpeechEmulationCompareFlags',
    'ISpeechGrammarRules', 'DISPID_SVEWord', 'SP_VISEME_16',
    'SpPhoneConverter', 'SVSFUnusedFlags', 'eLEXTYPE_PRIVATE20',
    'DISPID_SPAStartElementInResult', 'DISPID_SGRSTWeight',
    'DISPID_SLPType', 'DISPID_SpeechVoiceEvent', 'DISPID_SRRAudio',
    'DISPID_SRSAudioStatus', 'DISPID_SRIsShared',
    'DISPID_SREmulateRecognition', 'SpeechAudioVolume',
    'ISpeechLexiconPronunciation', 'SPEI_ADAPTATION', 'SVP_18',
    'SPGRAMMARWORDTYPE', 'ISpPhrase', 'ISpRecoResult',
    'DISPID_SPEActualConfidence', 'DISPID_SPPName',
    'DISPID_SRRGetXMLResult', 'DISPID_SPPFirstElement',
    'DISPID_SGRSTText', 'ISpeechObjectTokenCategory', 'SVP_10',
    'SP_VISEME_2', 'SINoise', 'SAFT22kHz16BitStereo', 'SPCS_DISABLED',
    'SVPOver', 'SpPhraseInfoBuilder', 'SAFTGSM610_11kHzMono',
    'ISpNotifySource', 'DISPID_SVSLastResult',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRCESoundStart',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRGIsPronounceable',
    'SpeechVoicePriority', 'SP_VISEME_14',
    'DISPID_SPPNumberOfElements', 'ISpeechPhoneConverter',
    'SAFTADPCM_8kHzStereo', 'DISPID_SVSInputSentencePosition',
    'SpStreamFormatConverter', 'eLEXTYPE_PRIVATE2', 'DISPID_SFSClose',
    'SVEPhoneme', 'SpeechAddRemoveWord', 'SAFT32kHz8BitMono',
    'DISPID_SOTId', 'SPEI_PROPERTY_STRING_CHANGE', 'SPAS_PAUSE',
    'DISPID_SRRAudioFormat', 'SPWAVEFORMATTYPE',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVAudioOutputStream',
    'SPAO_NONE', 'SpeechDataKeyLocation', 'SREAllEvents',
    'DISPID_SDKGetlongValue', 'ISpeechRecoResult2',
    'DISPID_SVEStreamStart', 'SpeechStreamSeekPositionType',
    'DISPID_SPRuleChildren', 'DISPID_SRAudioInputStream',
    'SPBO_AHEAD', 'SVP_12', 'SPPS_Noun', 'SECFIgnoreCase',
    'SGDisplay', 'SRTEmulated', 'SRSEDone',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRCState',
    'ISpEventSource', 'DISPID_SGRsAdd', 'DISPID_SABIBufferSize',
    'DISPID_SGRSRule', 'SpeechDisplayAttributes', 'SPEI_TTS_BOOKMARK',
    'SAFT22kHz8BitMono', 'SAFTGSM610_22kHzMono',
    'SVESentenceBoundary', 'DISPID_SGRsDynamic',
    'DISPID_SVSpeakCompleteEvent', 'SINone', 'DISPID_SRCVoice',
    'SpeechRecoProfileProperties', 'SpeechRecoContextState',
    'SPRECOSTATE', 'SGRSTTDictation', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechGrammarRule', 'SPRULESTATE', 'SVP_7',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechAudioFormat',
    'DISPID_SRSetPropertyString', 'SpeechTokenIdUserLexicon',
    'SVEEndInputStream', 'SRAInterpreter', 'DISPID_SVRate',
    'DISPID_SPRulesCount', 'SPBOOKMARKOPTIONS',
    'DISPID_SLWPronunciations', 'DISPID_SRDisplayUI',
    'DISPID_SRRTOffsetFromStart', 'SP_VISEME_7',
    'DISPID_SPISaveToMemory', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPCPhoneToId', 'DISPID_SPEEngineConfidence',
    'DISPID_SGRs_NewEnum', 'ISpeechObjectTokens', 'DISPID_SBSWrite',
    'SDKLDefaultLocation', 'SREHypothesis',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SPIProperties',
    'SPEI_REQUEST_UI', 'SpeechAudioState', 'SECNormalConfidence',
    'SPINTERFERENCE_NOISE', 'DISPID_SAFType', '__MIDL_IWinTypes_0009',
    'DISPID_SRCEStartStream', 'SPAUDIOOPTIONS', 'SpeechTokenContext',
    'ISpResourceManager', 'SVEStartInputStream',
    'DISPID_SRSClsidEngine', 'SAFTCCITT_uLaw_11kHzMono', 'SPSNoun',
    'SAFTADPCM_44kHzStereo', 'SPSUnknown', 'DISPID_SRGetFormat',
    'STCRemoteServer', 'SRTAutopause', 'DISPID_SpeechDataKey',
    'DISPID_SpeechAudioFormat', 'DISPID_SPELexicalForm',
    'DISPID_SVWaitUntilDone', 'DISPID_SVGetAudioInputs',
    'SVSFParseSapi', 'SREInterference', 'SINoSignal',
    'DISPID_SRCRecognizer', 'ISpRecognizer', 'SPPS_Modifier',
    'DISPID_SLWLangId', 'ISpeechLexicon', 'eLEXTYPE_RESERVED10',
    'ISpeechLexiconWords', 'DISPID_SLWType', 'SPEI_UNDEFINED',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SpeechRecognizer',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SPAs_NewEnum',
    'SAFT8kHz8BitMono', 'ISpNotifyTranslator', 'SPCT_SUB_DICTATION',
    'STCInprocHandler', 'DISPID_SLPsItem', 'SPAO_RETAIN_AUDIO',
    'DISPID_SDKDeleteValue', 'SPEVENTENUM',
    ...
    'DISPID_SpeechObjectTokens', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SVEViseme', 'SPPS_Unknown', 'SPXMLRESULTOPTIONS',
    'DISPID_SVPriority', 'ISpeechPhraseAlternates', 'DISPID_SBSSeek',
    'SPRS_INACTIVE', 'ISpRecognizer2', 'SITooFast',
    'ISpeechGrammarRule', 'SPEI_RESERVED1', 'ISpObjectWithToken',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SDKGetBinaryValue', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_HYPOTHESIS', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SVSRunningState', 'SDTAll', 'SPSHORTCUTPAIRLIST',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SABufferInfo', 'SPDKL_LocalMachine', 'SAFTText', 'SASRun',
    'DISPID_SDKSetBinaryValue', 'ISpeechBaseStream',
    'ISpeechMemoryStream', 'SAFT22kHz16BitMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SBSFormat', 'SRADynamic', 'SPAR_Medium',
    'ISpeechPhraseAlternate', 'DISPID_SASNonBlockingIO',
    'SPBO_TIME_UNITS', 'DISPID_SWFEBlockAlign', 'SPBO_PAUSE',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPRuleFirstElement',
    'SpeechVisemeFeature', 'DISPID_SVSkip', 'SREPropertyNumChange',
    'DISPID_SRCPause', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPPValue', 'SAFT11kHz8BitMono', 'DISPID_SPPId',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechGrammarState',
    'SpPhoneticAlphabetConverter', 'SVSFVoiceMask',
    'eLEXTYPE_RESERVED9', 'SPVPRIORITY', 'ISpeechRecoResultTimes',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPPChildren',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRCERecognition',
    'DISPID_SCSBaseStream', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SOTDisplayUI', 'DISPID_SVAlertBoundary',
    'SpeechRuleState', 'SITooLoud', 'DISPID_SLWs_NewEnum'
]

_check_version('1.1.13', 1652367850.426299)
