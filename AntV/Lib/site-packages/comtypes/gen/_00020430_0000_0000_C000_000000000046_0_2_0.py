...
__all__ = [
    'Gray', 'Font', 'IPictureDisp', 'FONTNAME', 'OLE_YSIZE_HIMETRIC',
    'OLE_CANCELBOOL', 'OLE_COLOR', 'OLE_YSIZE_CONTAINER',
    'OLE_YSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL', 'OLE_XPOS_PIXELS',
    'OLE_XSIZE_CONTAINER', 'OLE_YPOS_CONTAINER', 'Default',
    'OLE_YPOS_HIMETRIC', 'Unchecked', 'StdFont', 'OLE_TRISTATE',
    'FONTBOLD', 'VgaColor', 'OLE_XPOS_CONTAINER',
    'LoadPictureConstants', 'IFont', 'IFontEventsDisp', 'Checked',
    'IPicture', 'FONTSTRIKETHROUGH', 'FONTUNDERSCORE',
    'OLE_XSIZE_PIXELS', 'OLE_XSIZE_HIMETRIC', 'Color',
    'OLE_YPOS_PIXELS', 'FONTSIZE', 'IFontDisp', 'FONTITALIC',
    'OLE_XPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE', 'FontEvents',
    'Monochrome', 'StdPicture', 'Picture', 'OLE_HANDLE'
]

_check_version('1.1.13', 1622894692.653069)
